                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="/vote/candidates" role="button" aria-haspopup="true" aria-expanded="false" v-pre>
                                    Candidates
                                </a>
                            </li>

                            <li class="nav-item dropdown">
                                <a class="nav-link btn btn-primary" href="/results" role="button" aria-haspopup="true" aria-expanded="false" v-pre>
                                    Results
                                </a>
                            </li>
